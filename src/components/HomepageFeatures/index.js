    ...
    services: [
      {
        ...
        icon: require('@site/static/img/Logos/RiVidium Logo -Cyan-Block-2019 TRANS.png').default,
      },
      {
        ...
        <div className="flex items-center justify-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:translate-y-2 flex flex-col">
                {service.image ? (
                ...
                <div className="p-4 flex-grow flex flex-col justify-between">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="text-xl dark:text-black dark:opacity-80 font-semibold">{service.title}</h3>
                  </div>
                </div>
              </div>
            ))}
...
function BackgroundSquares() {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      <svg className="absolute left-[max(50%,25rem)] top-0 h-[64rem] w-[128rem] -translate-x-1/2 stroke-[--ifm-color-emphasis-300] [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)]" aria-hidden="true">
        <defs>
          <pattern id="e813992c-7d03-4cc4-a2bd-151760b470a0" width="200" height="200" x="50%" y="-1" patternUnits="userSpaceOnUse">
            <path d="M100 200V.5M.5 .5H200" fill="none" />
          </pattern>
        </defs>
        <svg x="50%" y="-1" className="overflow-visible fill-blue-200 dark:fill-blue-200 dark:opacity-20">
  ...
  return (
    <section className={`${styles.features} flex justify-center items-center min-h-screen`}>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="flex flex-col items-center justify-center space-y-16 max-w-4xl mx-auto">
